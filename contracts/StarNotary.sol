...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Rafael Murata Galaxy";
    string public constant symbol = "RMG";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerAddress1 == msg.sender || ownerAddress2 == msg.sender, "I don't own any stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "I can't transfer a star");
        address ownerAddress = ownerOf(_tokenId);
